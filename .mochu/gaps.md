...
| store-distribution | trust | Production-signed Android and iOS store builds are not shipped | The only GitHub release is a development-signed sideload APK; no Play Console, TestFlight, or App Store build is published | 5 | 5 | 5 | 5.0 |
